...
public class OrderController {
    ...
    // Endpoint to update an order's status to Cash Payment
    @PostMapping("/updatestatus/{orderId}")
    public ResponseEntity<String> updateOrderStatusToCashPayment(@PathVariable long orderId) {
        orderService.updateOrderStatusToCashPayment(orderId);
        System.out.println("Order status updated to Cash Payment for order ID: " + orderId);
        return ResponseEntity.ok("Order status updated to Cash Payment");
    }
